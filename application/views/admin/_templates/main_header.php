<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
            <header class="main-header">
                <a href="<?php echo site_url('admin/dashboard'); ?>" class="logo">
                    <span class="logo-mini" style="font-size: 14px"><b><?php echo $title_mini; ?></b></span>
                    <span class="logo-lg"><img src="https://4.bp.blogspot.com/-4J9oxdk2rU8/UOp8ZG3XZbI/AAAAAAAAKh8/6SO8Gr9S9h0/s320/LOGO+KEMENTERIAN+PEKERJAAN+UMUM.png" width="25" height="25" style="margin-right: 5px; margin-bottom: 3px"><b>SKPD</b></span>
                </a>
